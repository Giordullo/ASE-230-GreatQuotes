...
?>
            <p><?= $quoteArray[$i][$j] ?></p>
            <a onclick="window.location.href='detail.php?author=<?=$i?>&quote=<?=$j?>'" class="btn btn-primary" style="width: 15%">Details</a>
<?php
...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <?php getQuotes(); ?>
            <a onclick="window.location.href='create.php'" id="spacing_controls" class="btn btn-primary" style="width: 100%">Create Quote</a>
        </div>
